...
public class EngineExhaust implements IEntity {
	...
	public EngineExhaust(float x, float y, float parentWidth) {
		this.x = x;
		this.y = y;
		this.width = 0.02f;
		this.height = 0.08f;
		this.texID = Utility.loadPNGTexture("res\\textures\\exhaust.png", GL13.GL_TEXTURE0);
		setupGL();
		loadShader();
	}
	...
	{
		//load vertex shader
		int vsId = Utility.loadShader("res\\shader\\eeVertex.glsl", GL20.GL_VERTEX_SHADER);
		//load fragment shader
		int fsId = Utility.loadShader("res\\shader\\eeFragment.glsl", GL20.GL_FRAGMENT_SHADER);
		...
		this.irML = GL20.glGetUniformLocation(this.shaderID, "rotation_Matrix");
		...
		this.eeV = GL20.glGetUniformLocation(this.shaderID, "seed");
